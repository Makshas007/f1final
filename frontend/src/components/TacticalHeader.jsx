import { Activity, AlertTriangle, Radar, TimerReset, Users } from "lucide-react";
import { useSimStore } from "../store/simStore";

const Kpi = ({ icon: Icon, label, value, tone = "text-slate-100", testid }) => (
  <div className="flex items-center gap-3 border-l border-white/10 pl-5" data-testid={testid}>
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-x-6 gap-y-3">
        ...
        <Kpi
          ...
          tone={peak > 90 ? "text-red-400" : peak > 75 ? "text-orange-400" : "text-emerald-400"}
        />
        <Kpi
